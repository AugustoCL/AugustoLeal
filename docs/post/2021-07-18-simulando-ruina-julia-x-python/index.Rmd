...
Ao considerarmos um número de clientes inicial ($N_0$) e as premissas de 5% de desistência dos segurados atuais + o acréscimo de novos segurados que segue uma distribuição de $Poisson(\lambda)$ ($n^*$), podemos obter os seguintes passos para o tempo t=1 e t=2. 
