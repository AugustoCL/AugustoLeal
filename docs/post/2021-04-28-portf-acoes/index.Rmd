---
title: Analisando um Portfólio de Ações (Dashboard com R)
author: 'AugustoCL'
date: '2021-04-29'
slug: []
...
Esse projeto é um <u>[**dashboard interativo**](https://augustoleal.shinyapps.io/Portf_Analysis_ACL/)</u> onde é possível analisar um portfólio de até **5** ativos, a partir de 4 visões (**retorno**, **desvio padrão**, **assimetria** e **curtose**).

---

### [<u>Dashboard</u>](https://augustoleal.shinyapps.io/Portf_Analysis_ACL/)
...
O código inteiro do projeto está disponível neste [<u>**link**</u>](https://github.com/AugustoCL/DashPortfolio)  do Github.
...
**Curtose**: Descreve a intensidade de valores extremos na distribuição de retornos.Curtose alta significa recorrência de retornos extremos no histórico do ativo.![](./curtose.png)
